...
def build_pmu(design="pmu"):
    ...
    # Load all source
    chip.set('input', 'verilog', '../../../pmu/rtl/pmu/pmu.v')
    chip.add('input', 'verilog', '../../../pmu/rtl/pmu/pmu_core.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/sha/sha256_core.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/sha/sha256_k_constants.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/sha/sha256_w_mem.v')
    chip.add('input', 'verilog', '../../../pmu/rtl/pmu/tap_top.v')
    chip.add('input', 'verilog', '../../../pmu/rtl/pmu/key_storage.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/aes_core.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/aes_decipher_block.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/aes_inv_sbox.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/aes_key_mem.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/aes_sbox.v')
    # chip.add('input', 'verilog', '../../../pmu/rtl/pmu/aes/round_key.v')
