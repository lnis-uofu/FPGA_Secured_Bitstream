...
assign pmu_tdi_o = pmu_tdi_o_reg;
...
begin
  ...
  tms_q4 <=  tms_q3;
    ...
    assign tms_reset = tms_q1 & tms_q2 & tms_q3 & tms_q4 & tms_i;// | rst_flag;    // 5 consecutive TMS=1 causes reset
...
// Updating jtag_ir (Instruction Register)
always @ (latched_jtag_ir or tck_i)
begin
  ...
  if(shift_ir_neg)
    ...
    begin
      case(latched_jtag_ir_neg)    // synthesis parallel_case
        ...
        `PMU_W_CS:          tdo_comb = pmu_tdi_o;            
        `PMU_WO_CS:         tdo_comb = pmu_tdi_o;   
